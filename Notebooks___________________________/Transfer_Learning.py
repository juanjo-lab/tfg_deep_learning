...
model_file = 'adolescent#003-100-0.h5'
json_file = open('adolescent#003-100-0.json', 'r')
...
features_set = []
labels = []
train_record_number = len(glucose_training_set_scaled)# representa el numero de horas que se tiene guardado
...
test_features = []
labels_test = []
test_record_number = len(test_inputs) #horas de test recogidas
