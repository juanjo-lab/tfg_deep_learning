...
def new_mkdir(username):
    ...
    if not isExist:
        ...
        os.makedirs('/home/juanjo/PycharmProjects/glucosaRNN/Django/prueba_1/prueba_1/media/Re_entrenar/' + username,exist_ok=True)
        os.makedirs('/home/juanjo/PycharmProjects/glucosaRNN/Django/prueba_1/prueba_1/media/Predecir/' + username,exist_ok=True)
########################################################################################################################
