...
# -----------------------------------------------------------------------------------------------------------------------
    ...
    initial_path = '/prueba_1/media/Re_entrenar/Paciente_Nuevo/'
    initial_path_cp = '/prueba_1/media/Predecir/Paciente_Nuevo/'
    ...
    plt.savefig("/media/Re_entrenar/Loss_Nuevo_Paciente_" + str(num_epochs) + "_", bbox_inches="tight")


    plt.savefig("/home/juanjo/PycharmProjects/glucosaRNN/Django/prueba_1/prueba_1/Re_entrenar/static/media/Prediccion.png",bbox_inches="tight")
...
###############################################################################################################################
    ...
    plt.legend()
    plt.show()
    plt.savefig("/media/Re_entrenar/Prediccion_Nuevo_Paciente_" + str(num_epochs) + "", bbox_inches="tight")
    ########################################################################################################################
    ...
    if request.user.is_anonymous():
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                newdoc.save()
                Numero = len(glob.glob("/home/juanjo/PycharmProjects/glucosaRNN/Django/prueba_1/prueba_1/media/Crear_Red/Paciente_Nuevo/*.csv"))
